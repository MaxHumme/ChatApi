...
namespace MaxHumme\ChatApi\Framework\BehatExtension\ServiceContainer;
...
class BehatExtension implements Extension
{
    ...
    {
        $definition = new Definition('MaxHumme\ChatApi\Framework\BehatExtension\Context\KernelAwareInitializer', [$app]);
