...
use MaxHumme\ChatApi\Framework\BehatExtension\ServiceContainer\LaravelBooter;
...
class KernelAwareInitializer implements EventSubscriberInterface, ContextInitializer
{
     ...
     */
    public function __construct(\Laravel\Lumen\Application $kernel)
    {
        $this->kernel = $kernel;
    }
    ...
    public function rebootKernel()
    {
        ...
        $laravel = new LaravelBooter($this->kernel->basePath());
